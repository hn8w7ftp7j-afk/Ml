...
const betActionPolicy = fs.readFileSync(new URL('../lib/bet-action-state-v118.js', import.meta.url), 'utf8');
...
assert.match(betActionPolicy, /text: cancelled \? '重新紀錄下注' : '紀錄實際下注'/, 'a cancelled position must expose a clear rebet action');
