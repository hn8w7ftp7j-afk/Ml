...
records.push(record(order++, top + 25, [
  ...
  cell('明尼蘇達雙城', ...spans.teams, top + 25),
...
assert.equal(parsed.version, 'TAI888-READER-DOM-v2.0.1');
...
console.log('Tai888 split-row #/BS fixture: 8/8 standard MLB games parsed; special team-total section excluded');
