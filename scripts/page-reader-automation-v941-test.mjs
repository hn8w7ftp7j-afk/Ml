...
assert.equal(packageJson.version, '11.8.8', 'package/release identity must match the V11.8.8 PIT unconfirmed retry fix');
assert.equal(packageLock.version, '11.8.8', 'package-lock release identity must match V11.8.8');
assert.equal(packageLock.packages?.['']?.version, '11.8.8', 'root lockfile package must match V11.8.8');
assert.equal(APP_VERSION, '11.8.8');
