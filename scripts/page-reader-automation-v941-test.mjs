...
assert.equal(packageJson.version, '11.2.1', 'package/release identity must match the V11.2.1 database cutover');
assert.equal(packageLock.version, '11.2.1', 'package-lock release identity must match V11.2.1');
assert.equal(packageLock.packages?.['']?.version, '11.2.1', 'root lockfile package must match V11.2.1');
assert.equal(APP_VERSION, '11.2.1');
