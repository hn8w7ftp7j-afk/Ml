...
assert.equal(packageJson.version, '11.8.32', 'package/release identity must match the V11.8.32 NPB final-inning fix');
assert.equal(packageLock.version, '11.8.32', 'package-lock release identity must match V11.8.32');
assert.equal(packageLock.packages?.['']?.version, '11.8.32', 'root lockfile package must match V11.8.32');
assert.equal(APP_VERSION, '11.8.32');
