...
assert.equal(packageJson.version, '10.7.0', 'package/release identity must match the V10.7.0 UI');
assert.equal(packageLock.version, '10.7.0', 'package-lock release identity must match V10.7.0');
assert.equal(packageLock.packages?.['']?.version, '10.7.0', 'root lockfile package must match V10.7.0');
assert.equal(APP_VERSION, '10.7.0');
