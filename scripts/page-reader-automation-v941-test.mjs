...
assert.equal(packageJson.version, '11.8.23', 'package/release identity must match the V11.8.23 recovery-mode fix');
assert.equal(packageLock.version, '11.8.23', 'package-lock release identity must match V11.8.23');
assert.equal(packageLock.packages?.['']?.version, '11.8.23', 'root lockfile package must match V11.8.23');
assert.equal(APP_VERSION, '11.8.23');
