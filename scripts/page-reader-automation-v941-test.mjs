...
assert.equal(packageJson.version, '11.8.28', 'package/release identity must match the V11.8.28 original-price summary');
assert.equal(packageLock.version, '11.8.28', 'package-lock release identity must match V11.8.28');
assert.equal(packageLock.packages?.['']?.version, '11.8.28', 'root lockfile package must match V11.8.28');
assert.equal(APP_VERSION, '11.8.28');
