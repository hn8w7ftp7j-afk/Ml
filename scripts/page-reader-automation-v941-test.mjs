...
assert.equal(packageJson.version, '11.8.22', 'package/release identity must match the V11.8.22 completed-result retention fix');
assert.equal(packageLock.version, '11.8.22', 'package-lock release identity must match V11.8.22');
assert.equal(packageLock.packages?.['']?.version, '11.8.22', 'root lockfile package must match V11.8.22');
assert.equal(APP_VERSION, '11.8.22');
