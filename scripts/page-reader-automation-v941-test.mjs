...
assert.equal(packageJson.version, '10.7.2', 'package/release identity must match the V10.7.2 UI');
assert.equal(packageLock.version, '10.7.2', 'package-lock release identity must match V10.7.2');
assert.equal(packageLock.packages?.['']?.version, '10.7.2', 'root lockfile package must match V10.7.2');
assert.equal(APP_VERSION, '10.7.2');
