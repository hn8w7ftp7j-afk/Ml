...
assert.equal(packageJson.version, '11.8.35', 'package/release identity must match the V11.8.35 legacy PIT display fix');
assert.equal(packageLock.version, '11.8.35', 'package-lock release identity must match V11.8.35');
assert.equal(packageLock.packages?.['']?.version, '11.8.35', 'root lockfile package must match V11.8.35');
