...
assert.equal(packageJson.version, '11.8.0', 'package/release identity must match the V11.8.0 score-performance release');
assert.equal(packageLock.version, '11.8.0', 'package-lock release identity must match V11.8.0');
assert.equal(packageLock.packages?.['']?.version, '11.8.0', 'root lockfile package must match V11.8.0');
assert.equal(APP_VERSION, '11.8.0');
