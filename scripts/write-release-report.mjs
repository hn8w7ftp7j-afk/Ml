...
const ARCHIVE_NAME = 'Tai888-Reader-v2.0.8-RENDERED-LOCK-FIX.zip';
const SHA_NAME = `${ARCHIVE_NAME}.sha256`;
const REPORT_NAME = 'Tai888-Reader-v2.0.8-VERIFICATION.md';
...
const report = `# Tai888 Reader 2.0.8 / MLB EV 9.4.4 驗證報告
