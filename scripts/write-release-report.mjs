...
const ARCHIVE_NAME = 'Tai888-Reader-v2.0.6-DUPLICATE-DOM-FIX.zip';
const SHA_NAME = `${ARCHIVE_NAME}.sha256`;
const REPORT_NAME = 'Tai888-Reader-v2.0.6-VERIFICATION.md';
...
const report = `# Tai888 Reader 2.0.6 / MLB EV 9.4.2 驗證報告
