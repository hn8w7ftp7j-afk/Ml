...
const ARCHIVE_NAME = 'Tai888-Reader-v2.0.7-LOCKED-MARKET-FIX.zip';
const SHA_NAME = `${ARCHIVE_NAME}.sha256`;
const REPORT_NAME = 'Tai888-Reader-v2.0.7-VERIFICATION.md';
...
const report = `# Tai888 Reader 2.0.7 / MLB EV 9.4.4 驗證報告
