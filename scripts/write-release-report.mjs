...
const ARCHIVE_NAME = 'Tai888-Reader-v2.1.10-INTEGRATED-PARTIAL-SAFE.zip';
const SHA_NAME = `${ARCHIVE_NAME}.sha256`;
const REPORT_NAME = 'Tai888-Reader-v2.1.10-VERIFICATION.md';
...
const report = `# Tai888 Reader 2.1.10 / Baseball EV 9.7.0 驗證報告
...
| Gate | 結果 | 範圍 |
|---|---:|---|
| 專案測試 | PASS | ${testCount} 支既有 script + Reader 2.1.10 A–J 專項，包含亞洲聯盟隊名、跨聯盟 DOM、partial market、freshness isolation、trailing rerun、server/auth/integrity 與 UI 回歸 |
...
- Reader 2.1.10 以 MLB／NPB／KBO／CPBL 四個權威分頁獨立辨識、雜湊、同步與顯示狀態；日／韓／台可從 Tai888 可見隊名建立正式代碼，每個已開市場仍須雙方向完整。
