...
assert.equal(settledBetToPitObservationV109({ ...bet, pitPrediction: prediction.prediction, status: 'OPEN' }), null);
const observed = settledBetToPitObservationV109({ ...bet, pitPrediction: prediction.prediction, status: 'SETTLED', settlement: { roi: 0.965, settledAt: '2026-08-25T05:00:00.000Z' } });
