...
assert.ok(neutralScore >= 4.4 && neutralScore <= 5.1);
...
assert.ok(scoreFromCompositeEV(-0.12, { weightedEV: -0.14, robustEV: -0.15, flipProbability: 0.90, quality: 0.80, edgeStrength: -1, stability: 0.10 }) >= 1);
...
assert.equal(validateScoreContract(candidateScore, 0.041, { weightedEV: 0.052, robustEV: 0.043, flipProbability: 0.12, quality: 0.85, edgeStrength: 0.55, stability: 0.80, modelErrorFloor: 0.025, independentEvidence: 0.65, divergenceRisk: 0.05 }).ok, true);
...
assert.ok(analysis.results.every(row => Number.isFinite(row.score) && row.score >= 1 && row.score <= 9.4));
