...
// Model smoke and dominance checks.
...
assert.ok(analysis.results.every(x=>Number.isFinite(x.score)&&Number.isFinite(x.ev)&&x.modelProbability>=0&&x.modelProbability<=1));
const samePick=[
...
console.log('All MLB Positive EV v3 unit tests passed');
