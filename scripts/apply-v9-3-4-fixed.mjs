...
// Tai888 source: detect Cloudflare browser challenge and stop cleanly.
{
...
// Credit-lines API: Cloudflare is a supported blocked state, not a fatal board error.
{
...
// Frontend: deterministic one-click reference analysis plus clipboard/text fallback.
{
  ...
  const functions = functionLines.join('\n');
  source = replaceExact(
    source,
...
// Styling for the text-import fallback.
{
