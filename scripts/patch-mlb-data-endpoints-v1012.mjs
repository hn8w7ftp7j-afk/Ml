...
function replaceExact(path,before,after){let s=fs.readFileSync(path,'utf8');if(!s.includes(before))throw new Error(`${path}: anchor not found`);fs.writeFileSync(path,s.replace(before,after));}
