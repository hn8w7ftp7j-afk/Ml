export const ASIAN_LEAGUE_READINESS_VERSION = 'ASIAN-LEAGUE-RELEASE-READINESS-2026-08-v1.0.0';
...
function readinessFor(leagueId) {
  const displayBlockers = [
    DISTRIBUTION_ENGINE_BLOCKER,
    ...COMMON_PRODUCTION_PIPELINE_BLOCKERS,
    ...LEAGUE_SPECIFIC_PIPELINE_BLOCKERS[leagueId],
  ];
  return Object.freeze({
    ...
    availableServices: Object.freeze(['OFFICIAL_SCHEDULE', 'TAI888_READER', 'BET_LEDGER', 'FULL_GAME_FINAL_SCORE']),
    displayAnalysisBlockers: Object.freeze(displayBlockers),
...
export function asianDistributionEngineBlocker(value) {
  return { leagueId: strictAsianLeague(value), ...cloneBlocker(DISTRIBUTION_ENGINE_BLOCKER) };
}
