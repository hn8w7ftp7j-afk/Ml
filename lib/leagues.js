export const LEAGUE_REGISTRY_VERSION = 'SPORTS-LEAGUE-REGISTRY-2026-08-v2.2.0';
...
const REGISTRY = Object.freeze({
  ...
  NPB: Object.freeze({
    ...
    shortLabel: '日棒',
    status: 'shadow',
    statusLabel: '驗證中分析排名｜缺失棒球狀態會明確標示',
