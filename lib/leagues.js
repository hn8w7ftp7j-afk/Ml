export const LEAGUE_REGISTRY_VERSION = 'SPORTS-LEAGUE-REGISTRY-2026-08-v2.1.0';

export const LEAGUE_IDS = Object.freeze(['MLB', 'NPB', 'KBO', 'CPBL']);

const SHADOW_CAPABILITIES = Object.freeze({
  schedule: true,
  reader: true,
  analysis: true,
  ranking: true,
