...
export const SCORE_FORMULA_VERSION = 'DUAL-EV-BOTTLENECK-2026-08-v1.6.0';
...
export function deterministicScore(input = {}) {
  ...
  if (!crossMarketVerified && weightedEV.gte(SCORE_BANDS.strongest.weightedLower) && robustEV.gte(SCORE_BANDS.strongest.robustLower)) caps.push('INDEPENDENT_MARKET_AUDIT_UNAVAILABLE');
