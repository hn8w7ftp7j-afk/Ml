...
export const SCORE_FORMULA_VERSION = 'DUAL-EV-BOTTLENECK-2026-09-v1.9.2';
export const SCORE_POLICY_VERSION = 'FOUR-LEAGUE-CONTINUOUS-DUAL-EV-SCORE-2026-09-v13';
...
export function deterministicScore(input = {}) {
  ...
  const publishedBand = band.id;

  if (published.gte(9)) { published = new Decimal('8.9'); caps.push('GENERAL_SINGLE_BET_MAX_8_9'); }
  // External market evidence is audit-only and never caps the W/R score.
