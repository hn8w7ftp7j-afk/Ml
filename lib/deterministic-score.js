...
export const SCORE_FORMULA_VERSION = 'DUAL-EV-BOTTLENECK-2026-08-v1.3.0';
...
export function deterministicScore(input = {}) {
  ...
  // Model/market disagreement is a QA diagnostic or BLOCK decision. It is not
  // permitted to rewrite a score that must be determined only by Weighted EV
  // and Robust EV.
  if (published.gte(9)) {
