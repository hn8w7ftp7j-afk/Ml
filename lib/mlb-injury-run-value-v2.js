...
export function buildInjuryRunValueV2({ injuredRoster, lineup, teamOps = 0.72, leagueOps = 0.72, observedAt = '' } = {}) {
  ...
  const regressedAbsentRuns = rawAbsentRuns * clamp(0.45 + coverage * 0.35, 0.45, 0.80);
  return {
    ...
    rawValue: { absentRunsPerGame: rawAbsentRuns, replacementOps },
    regressedValue: { absentRunsPerGame: regressedAbsentRuns },
