...
export function auditAsianSourceEvidence(context = {}) {
  ...
  const required = ['gameIdentity', 'history', 'away.starter', 'home.starter', 'away.lineup',
  ...
  return { version: ASIAN_SOURCE_EVIDENCE_VERSION, inputCutoffAt: context.inputCutoffAt || null, pregameCutoffStatus,
    ...
    rows, scope: 'BOUND_SOURCE_CONTENT_AND_ACQUISITION_TIMING', predictiveAccuracyValidated: false };
}
