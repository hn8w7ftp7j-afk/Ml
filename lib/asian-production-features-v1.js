...
export const ASIAN_PRODUCTION_FEATURES_V1_VERSION = 'ASIAN-OFFICIAL-PIT-PLAYER-PIPELINES-2026-09-v1.0.8';
...
async function buildCpbl(game, history, options, starterEvidence) {
  ...
  return { details, identity, starterStats, gamePatch, batterRates, currentLineups: currentPersonnel?.lineups || null };
}
