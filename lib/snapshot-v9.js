...
export const DATA_VERSION = 'MLB-DATA-SNAPSHOT-2026-08-v1.0.0';
export const REPRICE_VERSION = 'MLB-FROZEN-CONTEXT-REPRICE-2026-08-v1.0.0';
...
export function buildSnapshotFingerprints({ context, markets, versions = {} }) {
  ...
  const inputHash = sha256({ coreFingerprint, priceFingerprint, versions });
  return {
    coreFingerprint,
    priceFingerprint,
    inputHash,
