...
export const SNAPSHOT_FINGERPRINT_VERSION = 'BASEBALL-SNAPSHOT-FINGERPRINT-v2.0.0';
...
export function buildSnapshotFingerprints({
  ...
  const corePayload = {
    domain: 'baseball-positive-ev/snapshot-core/v2',
    league,
    game: context?.game,
  ...
  const pricePayload = {
    domain: 'baseball-positive-ev/snapshot-price/v2',
    league,
