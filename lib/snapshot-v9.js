...
export const REPRICE_VERSION = 'BASEBALL-FROZEN-CONTEXT-REPRICE-2026-08-v11.0.0';
export const SNAPSHOT_FINGERPRINT_VERSION = 'BASEBALL-SNAPSHOT-FINGERPRINT-v4.0.0';
...
export function buildSnapshotFingerprints({
  ...
  const pricePayload = {
    domain: 'baseball-positive-ev/snapshot-price/v3',
    league,
  ...
  const auxiliaryPayload = {
    domain: 'baseball-positive-ev/snapshot-auxiliary/v2',
    league,
