export const GAME_DISTRIBUTION_CACHE_VERSION = 'BASEBALL-GAME-DISTRIBUTION-CACHE-v1.1.0';
export const GAME_DISTRIBUTION_CACHE_TTL_MS = 5 * 60 * 1000;

const maximumEntries = 64;
const cache = globalThis.__BASEBALL_GAME_DISTRIBUTION_CACHE_V110__ || new Map();
globalThis.__BASEBALL_GAME_DISTRIBUTION_CACHE_V110__ = cache;
