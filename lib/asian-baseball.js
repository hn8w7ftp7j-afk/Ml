...
export const ASIAN_BASEBALL_VERSION = 'ASIAN-BASEBALL-OFFICIAL-PROVIDERS-2026-08-v2.0.0';
export const ASIAN_SCHEDULE_VERSION = 'ASIAN-OFFICIAL-SCHEDULE-2026-08-v1.0.0';
export const ASIAN_CONTEXT_VERSION = 'ASIAN-SHADOW-CONTEXT-2026-08-v2.0.0';
...
export async function buildAsianGameContext(value, game, {
  ...
  const dataGateV10 = {
    version: 'ASIAN-CORE-UPSTREAM-GATE-2026-08-v2.0.0',
    featureContractVersion: config.featureContract.version,
    rows: rows.map(({ ready, ...row }) => row),
