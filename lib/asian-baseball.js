...
export const ASIAN_BASEBALL_VERSION = 'ASIAN-BASEBALL-OFFICIAL-PROVIDERS-2026-09-v2.2.0';
export const ASIAN_SCHEDULE_VERSION = 'ASIAN-OFFICIAL-SCHEDULE-2026-09-v1.1.1';
export const ASIAN_CONTEXT_VERSION = 'ASIAN-SHADOW-CONTEXT-2026-09-v2.2.0';
...
function predictedTeamContext(team, supplied, modelConfig, leagueId, allowPrediction) {
  ...
  const rawCandidates = Array.isArray(supplied?.starter?.candidates)
  ...
  return {
    ...
    starter: starterObservedReady || !starterForecastAvailable ? team.starter : {
      ...
      projectionMode: candidateMixtureReady ? 'OFFICIAL_PRIOR_START_ROTATION_MIXTURE'
        : primaryPerformanceReady ? 'PROJECTED_ASSIGNMENT_WITH_OBSERVED_INDIVIDUAL_PERFORMANCE' : 'LEAGUE_NEUTRAL_ROTATION_SCENARIO',
      source: candidates.length || primaryPerformanceReady
