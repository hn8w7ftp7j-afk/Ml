...
export async function buildAsianGameContext(value, game, {
  ...
  const rows = [
    ...
    { name: 'starterIdentityAndIndependentPerformance', ready: both('starterIdentity') && both('starterPerformance') || bothForecast('starter'), status: both('starterIdentity') && both('starterPerformance') ? 'CONFIRMED' : bothForecast('starter') ? 'PROJECTED' : 'MISSING', core: true },
