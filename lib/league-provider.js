...
import { MODEL_VERSION, RULES_VERSION } from './analysis.js';
import { isLeagueId, leagueConfig, requestedLeagueId } from './leagues.js';

export const LEAGUE_PROVIDER_VERSION = 'BASEBALL-LEAGUE-PROVIDER-2026-08-v1.0.0';
...
export function getLeagueProvider(value) {
  ...
  return {
    ...
    betEligible: registry.capabilities.bets === true && contract.betEligible === true,
    executable: registry.capabilities.bets === true && contract.executable === true,
