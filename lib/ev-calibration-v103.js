...
export const EV_CALIBRATION_V103_VERSION = 'INDEPENDENT-CONSENSUS-PRICE-EV-GATE-2026-08-v10.4.0';
...
export function qualifyEvV103({ row, rawWeightedEV, rawRobustEV, modelProbability, rebateRate = 0.015, gate = {} }) {
  ...
  if (quality < MINIMUM_DATA_QUALITY) reasons.push(`資料品質${quality.toFixed(2)}低於${MINIMUM_DATA_QUALITY.toFixed(2)}安全門檻`);
  if (!priorEligible) {
