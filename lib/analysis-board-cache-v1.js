...
// v5 invalidates snapshots created before the v1.9.1 score-display contract.
// Older cached QA-warning rows can contain a permanently null S even though a
// fresh deterministic analysis must now retain the fixed formula value.
