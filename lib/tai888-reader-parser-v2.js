...
export const TAI888_READER_PARSER_VERSION = 'TAI888-READER-PARSER-v2.2.0';
...
function readerError(message, status = 422, code = '') {
...
export function validateTai888ReaderEnvelope(payload, {
  ...
  if (pageActivityTime > observedTime + 5_000
    ...
    throw readerError('Tai888 頁面活動時間已過期或不合理', 409, 'PAGE_ACTIVITY_STALE');
  }
