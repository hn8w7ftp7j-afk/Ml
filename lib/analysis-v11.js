...
export const RULES_VERSION = 'BASEBALL-MODEL-EV-OPTIONAL-INDEPENDENT-AUDIT-2026-08-v10.5.1';
export const ANALYSIS_V11_VERSION = 'BASEBALL-CORRELATED-JOINT-DISTRIBUTION-EV-2026-08-v10.5.1';
...
export function evaluateMarketsFromDistribution({ context, markets, previousMarkets = [], settings = {}, distributionSnapshot }) {
      ...
      results.push({
        ...
        outcomeProbabilitiesSource: evCalibration.qualified
          ? marketBaselineApplied
            ...
            : '同一份棒球聯合比分分布；Tai888只作成交payoff；獨立市場僅為可選外部稽核'
  ...
  const analysis = {
    ...
    distributionSnapshot, createdAt: new Date().toISOString(), analysisStatus: 'V10.5.1聯合比分分布模型EV｜Tai888只作成交價｜獨立市場為可選外部稽核', dataQuality: gate.quality, dataQualificationQuality: gate.qualificationQuality ?? gate.quality, dataGateV10: gate,
    ...
    scenarioSummary: { count: scenarios.length, simulationsPerScenario: 0, conservativeQuantile: .10, sharedDistribution: true, jointPortfolioDistribution: true, exactDistribution: true, quadratureVersion: distributionSnapshot.quadratureVersion, runProfileVersion: distributionSnapshot.runProfileVersion, evCalibrationVersion: EV_CALIBRATION_V103_VERSION, persistedForReprice: true, targetPriceCalibratesDistribution: provisionalBaselineApplied, marketProbabilityCalibrationApplied: provisionalBaselineApplied, legacyDistributionUsed: false },
    alignmentAudit: { instructionVersion: 'V10.5.1 PIT棒球資料→相關風險聯合比分分布→Tai888逐腿payoff→W/R→QA→固定雙EV影子分數', targetMarketCalibration: provisionalBaselineApplied ? 'PROVISIONAL_EXTREME_GAP_MARKET_BASELINE' : 'DISABLED_EXECUTION_PRICE_ONLY', independentMarketRole: 'OPTIONAL_EXTERNAL_AUDIT_ONLY', legacyContext: context?.legacyContextUsed === false ? 'DISABLED' : 'BLOCK', legacyDistribution: 'DISABLED', gptNumericScoring: 'DISABLED', formalRecommendation: 'DISABLED_UNTIL_LOCKED_OOS_FORWARD_VALIDATION' },
