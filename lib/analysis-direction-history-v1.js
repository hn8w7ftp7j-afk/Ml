  ...
  const inserted = await sql()`
    WITH incoming AS (
      ...
      JOIN baseball_analysis_pit_snapshots p
        ...
        AND date_trunc('milliseconds', p.analysis_as_of) = i.analysis_as_of
        AND date_trunc('milliseconds', p.data_as_of) = i.data_as_of
        AND date_trunc('milliseconds', p.line_as_of) = i.line_as_of
