...
export const REFERENCE_LINES_VERSION = 'REFERENCE-LINES-2026-09-v1.5.0';
...
export function referenceProviderStatus(env = process.env) {
  ...
  return {
    ...
    providers: [
      ...
      { id: 'THE_ODDS_API_CONSENSUS', configured: odds, label: '國際市場驗證盤｜The Odds API' },
    ],
  };
}
