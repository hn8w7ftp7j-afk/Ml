...
export const REFERENCE_LINES_VERSION = 'REFERENCE-LINES-2026-08-v1.3.0';
...
function oddsApiMarkets(raw, game, fetchedAt) {
  ...
  return result.sort((left, right) => (marketOrder.get(left.market) ?? 99) - (marketOrder.get(right.market) ?? 99));
}
