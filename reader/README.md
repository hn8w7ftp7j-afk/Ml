# Tai888 Reader v2.1.19 UNATTENDED-RECOVERY
...
8. 在擴充功能頁確認顯示 `2.1.19 UNATTENDED-RECOVERY`。

## 無人值守恢復

- Reader 每分鐘檢查一次盤面活動時間。
- Tai888 分頁無回應或盤面活動超過 3 分鐘時，先重新掛上監聽並重掃。
- 重掃仍無效時，只自動重新整理發生問題的聯盟分頁；其他聯盟不受影響。
- 自動刷新後等待盤面載入並重新同步，90 秒內不重複刷新同一分頁。
- Tai888 登出、Chrome 關閉或電腦休眠時仍需人工恢復登入或開機。
