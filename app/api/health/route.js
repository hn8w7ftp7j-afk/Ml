...
export async function GET(request) {
  ...
  return NextResponse.json({
    ...
    referenceLinesEnabled: referenceStatus.externalAuditEnabled,
    referenceConsensusReady: referenceStatus.consensusReady,
    externalMarketAuditEnabled: referenceStatus.externalAuditEnabled,
    ...
    referenceConsensusPolicy: 'AUDIT_ONLY_THREE_UNIQUE_BOOKS_5M_FRESH_3M_SYNCHRONIZED_EXACT_CONTRACT',
