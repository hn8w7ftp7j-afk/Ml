  ...
  try {
    ...
    if (unchangedBoard
      ...
      return NextResponse.json({
        ...
        league,
        heartbeat: true,
        message: `Tai888 Reader 心跳正常｜已開盤 ${refreshed.matchedGameCount} 場｜市場 ${refreshed.marketCount || 0} 個｜未開盤 ${refreshed.unopenedGameCount || 0} 場`,
        ...
        marketCount: refreshed.marketCount || 0,
        directionCount: refreshed.directionCount || 0,
        partialGameCount: refreshed.partialGameCount || 0,
    ...
    return NextResponse.json({
      ...
      marketCount: normalized.marketCount || 0,
      directionCount: normalized.directionCount || 0,
      partialGameCount: normalized.partialGameCount || 0,
